      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          <a href="#accueil" className="flex flex-col leading-none">
            <span className="font-serif text-xs tracking-[0.2em] uppercase text-white/50">Electrolyse</span>
            <span className="font-serif text-xl italic text-white tracking-wide">Signature</span>
          </a>
